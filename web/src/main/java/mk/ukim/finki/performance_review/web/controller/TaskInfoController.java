...
public class TaskInfoController {
    ...
    @GetMapping("/{id}")
    public String showTaskInfo1(@PathVariable Long id, @RequestParam(required = false) String error,
    ...
    public String addAssignee1(@PathVariable Long id, HttpServletRequest request){
